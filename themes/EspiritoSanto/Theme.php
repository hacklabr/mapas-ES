...
Além de alimentar o banco de dados da cultura capixaba, o mapa também é a base do cadastro dos beneficiários da Lei Aldir Blanc no Espírito Santo.',
            ...
            'home: welcome' => "O Mapa Cultural ES é uma plataforma livre, colaborativa e interativa de mapeamento do cenário cultural capixaba, além de ser um instrumento de governança digital no aprimoramento da gestão pública, dos mecanismos de participação e da democratização do acesso às políticas culturais promovidas pela Secretaria da Cultura do Estado do Espírito Santo.</br></br>Além de ser uma ferramenta de comunicação - que visibiliza os eventos presentes no calendário cultural, os projetos desenvolvidos e os espaços promovidos pelos agentes e instituições culturais do Espírito Santo - é plataforma de acesso e execução dos editais realizados pela Secretaria, bem como de oportunidades de demais agentes e espaços culturais. </br></br> Você também pode colaborar na gestão da cultura do estado: basta criar seu perfil de agente cultural. A partir do cadastro, fica mais fácil participar dos editais e programas da Secretaria e também divulgar seus eventos, espaços ou projetos.
            ",
