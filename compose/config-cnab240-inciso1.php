...
return [
    'HEADER1' => [
        ...
        'NOME_EMPRESA' => [ //Nome da fonte pagadora
            'length' => 30,
            'default' => 'FUNDO DE CULTURA DO ESTADO DO',
            'field_id' => null,
            'type' => 'string',
        ],
    ...
    'HEADER2' => [
        ...
        'FORMA_LANCAMENTO' => [
            'length' => 2,
            'default' => '01', // A separação desse dado hoje ocorre de forma automática dúvidas analisar particularidades BB
            'field_id' =>  null,
            'type' => 'int',
        ],
        ...
        'LOGRADOURO' => [ // Logradouro do endereço da fonte pagadora
            'length' => 30,
            'default' => 'Rua Luiz Gonzáles Alvarado',
            'field_id' => null,
            'type' => 'string',
        ],
    ...
    'parameters_default' => [
        ...
        'selfDeclaredBB' => 'field_1', // Preencher esse campo, caso exista a pergunta se o requerente é correntista BB ou Não
        ...
        'field_TipoConta' => 'field_17',// Field_id que busca o tipo de do benefíciario conta corrente ou poupança
        'field_banco' => 'field_6', // Field_id que busca o banco do benefpiciario
        'field_agency' => 'field_16',
        ...
        'fromToAccounts' => 'CSV/fromToAccounts.csv', // Caso exista um arquivo vom numero de contas    
