...
return [
    ...
    "header" => [
        ...
        [
            ...
            "type" => "int",
            "name" => "mciEmpresa",
            "default" => 105161915, // preenchimento SECULT
        ],
        [
            "length" => 5,
            "type" => "int",
            "name" => "numeroProcesso",
            "default" => 91734, // preenchimento SECULT
        ],
        [
            "length" => 5,
            "type" => "int",
        ...
        [
            ...
            "type" => "int",
            "name" => "agenciaEmpresa",
            "default" => 3665, // preenchimento SECULT
        ],
        [
            "length" => 1,
            "type" => "text",
        ...
        [ // detail09, primeira referência
            "fields" => [
                ...
                [
                    ...
                    "type" => "text",
                    "name" => "nomeReferencia",
                    "default" => "Marianne Malini", // preenchimento SECULT
                ],
                [
                    "length" => 4,
                    "type" => "text",
                    "name" => "dddReferencia",
                    "default" => "(27)", // preenchimento SECULT
                ],
                [
                    "length" => 9,
                    "type" => "text",
                    "name" => "telefoneReferencia",
                    "default" => "999024439", // preenchimento SECULT
                ],
                [
                    "length" => 70,
                    "type" => "text",
        ...
        [ // detail10, segunda referência
            "fields" => [
                ...
                [
                    ...
                    "type" => "text",
                    "name" => "nomeReferencia",
                    "default" => "Lívia Ascava", // preenchimento SECULT
                ],
                [
                    "length" => 4,
                    "type" => "text",
                    "name" => "dddReferencia",
                    "default" => "(11)", // preenchimento SECULT
                ],
                [
                    "length" => 9,
                    "type" => "text",
                    "name" => "telefoneReferencia",
                    "default" => "996641511", // preenchimento SECULT
                ],
                [
                    "length" => 70,
                    "type" => "text",
        ...
        "records" => [
            "00000" => [ // header
                ...
                [
                    ...
                    "type" => "int",
                    "name" => "numeroProcesso",
                    "match" => 91734, // preenchimento SECULT
                ],
                [
                    "length" => 5,
                    "type" => "int",
